    ...
    <body>
        ...
        <script>
                ...
                columns: [
                    // CNPJ
                    {
                        ...
                        render: function (data, type, row) {
                            ...
                            let retorn = "<a href='#' onclick=\"OpenLink('empresa/" + cnpj + "');\">" + cnpj.replace(/^(\d{2})(\d{3})(\d{3})(\d{4})(\d{2})$/, '$1.$2.$3/$4-$5') + "</a>";
                            return retorn;
                        },
                        className: "text-justify"
                    },
                    // Razão Social
                    {data: 'Razão Social', className: "text-justify"},
                    // Nome Fantasia
                    {data: 'Nome Fantasia', className: "text-justify"},
                    // Telefone
                    {data: 'Telefone', className: "text-center"},
                    // E-mail
                    {data: 'E-mail', className: "text-center"},
                    // Endereço
                    {data: 'Endereço', className: "text-justify"},
                    // Cidade
            ...
            $(document).ready(function () {
                var ajax1 = $.ajax({
                    url: "source/form/empresas/getall.php",
                    type: 'POST',
                    dataType: 'json',
                    beforeSend: function () {
                        ...
                        .done(function (data) {
                            ...
                            for (var i = 0; i < data.length; i++) {
                                rowsemp += "<tr>";
                                rowsemp += "<th>" + data[i].cnpj + "</th>";
                                rowsemp += "<td>" + data[i].razao_social + "</td>";
                                rowsemp += "<td>" + data[i].nome_fantasia + "</td>";
                                rowsemp += "<td>" + data[i].telefone + "</td>";
                                rowsemp += "<td>" + data[i].email + "</td>";
                                rowsemp += "<td>" + data[i].endereco + "</td>";
                                rowsemp += "<td>" + data[i].cidade + "</td>";
                                rowsemp += "<td>" + data[i].estado + "</td>";
                                rowsemp += "</tr>";
                            }
