    ...
    <body>
        ...
        <script>
                ...
                columns: [
                    // CPF
                    {
                        ...
                        render: function (data, type, row) {
                            ...
                            let retorn = "<a href='#' onclick=\"OpenLink('cliente/" + cpf + "');\">" + cpf.replace(/(\d{3})(\d{3})(\d{3})(\d{2})/, '$1.$2.$3-$4') + "</a>";
                            return retorn;
                        },
                    ...
                    // Sexo
                    {
                        ...
                        render: function (data, type, row) {
                            if (data == 0) {
                                return '<font class="text-danger">F</font>';
                            } else if (data == 1) {
                                return '<font class="text-primary">M</font>';
                            } else {
                                return data;
                            }
                        },
            ...
            $(document).ready(function () {
                var ajax1 = $.ajax({
                    url: "source/form/clientes/getall.php",
                    type: 'POST',
                    dataType: 'json',
                    beforeSend: function () {
                        ...
                        .done(function (data) {
                            ...
                            for (var i = 0; i < data.length; i++) {
                                rowsclient += "<tr>";
                                rowsclient += "<th>" + data[i].cpf + "</th>";
                                rowsclient += "<td>" + data[i].nome + "</td>";
                                rowsclient += "<td>" + data[i].rg + "</td>";
                                rowsclient += "<td>" + data[i].nascimento + "</td>";
                                rowsclient += "<td>" + data[i].sexo + "</td>";
                                rowsclient += "<td>" + data[i].email + "</td>";
                                rowsclient += "</tr>";
                            }

                            $('#rowdata').html(rowsclient);
